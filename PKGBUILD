...
pkgver=13.0.0_r380695.50542d504dd8
pkgrel=1
...
package_lldb-git() {
    ...
    depends=("clang-git=$pkgver-$pkgrel" "llvm-libs-git=$pkgver-$pkgrel" "python" "libedit" "libxml2")
...
package_polly-git() {
    ...
    depends=("llvm-libs-git=$pkgver-$pkgrel" "gcc-libs")
...
package_clang-git() {
    ...
    depends=("llvm-git=$pkgver-$pkgrel" 'gcc' "python" 'python2' 'perl')
